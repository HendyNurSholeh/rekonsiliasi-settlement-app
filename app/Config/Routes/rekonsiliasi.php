...
$routes->group('rekon', ['namespace' => 'App\Controllers\Rekon'], function($routes) {
    ...
    $routes->group('process', ['namespace' => 'App\Controllers\Rekon\Process'], function($routes) {
        ...
        $routes->get('direct-jurnal-rekap', 'DirectJurnal\RekapDirectJurnalController::index', ['as' => 'rekon.process.direct-jurnal-rekap']);
        $routes->get('penyelesaian-dispute', 'DirectJurnal\DisputeResolutionController::index', ['as' => 'rekon.process.penyelesaian-dispute']);
        $routes->get('direct-jurnal/dispute/datatable', 'DirectJurnal\DisputeResolutionController::disputeDataTable', ['as' => 'rekon.process.dispute.datatable']);
        $routes->post('direct-jurnal/dispute/datatable', 'DirectJurnal\DisputeResolutionController::disputeDataTable', ['as' => 'rekon.process.dispute.datatable.post']);
        $routes->post('direct-jurnal/dispute/detail', 'DirectJurnal\DisputeResolutionController::getDisputeDetail', ['as' => 'rekon.process.dispute.detail']);
        $routes->post('direct-jurnal/dispute/update', 'DirectJurnal\DisputeResolutionController::updateDispute', ['as' => 'rekon.process.dispute.update']);
