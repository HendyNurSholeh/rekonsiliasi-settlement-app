...
class TampAgnSettleEduModel extends Model
{
    protected $table      = 'tamp_agn_settle_edu';
    ...
    public function insertBatchData($data, $batchSize = 500)
    {
        ...
        foreach ($chunks as $chunk) {
            try {
                ...
                log_message('error', 'TampAgnSettleEduModel insertBatchData error: ' . $e->getMessage());
                throw $e;
            }
        }
