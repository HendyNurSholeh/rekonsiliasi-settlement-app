...
class LaporanTransaksiDetailController extends BaseController
{
     ...
     * Menampilkan data transaksi detail dengan berbagai filter
     */
    ...
    /**
     * DataTables AJAX endpoint for laporan transaksi detail
     */
    ...
    public function updateDispute()
    {
        ...
        try {
            ...
            $this->logActivity([
                ...
                'description' => 'Update Data Button Proses Rekonsiliasi/Laporan Transaksi Detail',
                'event' => EventLogEnum::UPDATED,
                'subject_id' => $id,
                'subject' => 'Menu: Proses Rekonsiliasi/Laporan Transaksi Detail',
