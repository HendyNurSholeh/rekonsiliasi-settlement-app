...
function showCallbackLogModalByRef(refNumber) {
	...
	console.log('Making AJAX request to:', `${window.appConfig.baseUrl}/settlement/jurnal-escrow-biller-pl/get-callback-by-request-id/${encodeURIComponent(refNumber)}`);
	console.log('Request data - refNumber:', refNumber, 'encoded:', encodeURIComponent(refNumber));

	$.ajax({
		url: `${window.appConfig.baseUrl}/settlement/jurnal-escrow-biller-pl/get-callback-by-request-id/${encodeURIComponent(refNumber)}`,
		type: 'GET',
		dataType: 'json',
...
function showCallbackDetailModal(logId) {
	...
	$.ajax({
		url: `${window.appConfig.baseUrl}/settlement/jurnal-escrow-biller-pl/get-callback-detail/${logId}`,
		type: 'GET',
		dataType: 'json',
